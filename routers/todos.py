...
class TodoRequest(BaseModel):
    ...
    title: str = Field(min_lenght=3, max_lenght=250)
    description: str = Field(min_lenght=3, max_lenght=250)
...
async def create_book(user: user_dependency, db: db_dependency, todo_request: TodoRequest):
...
async def delete_book(user:user_dependency, db: db_dependency, todo_id: int = Path(gt=0)):
